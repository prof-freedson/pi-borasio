    ...
    <div className="min-h-screen flex flex-col items-center space-y-10 bg-[#DAF3D7] bg-cover bg-center">
      ...
      <div className="bg-white/50 p-6 rounded-2xl shadow-lg w-1/2 mb-1 space-y-4">
        ...
        {modoEdicao ? (
          ...
          <>
            <div>
              <label className="block text-gray-600 text-sm"><FontAwesomeIcon icon={faUser} className="mr-2 text-green-800" /> Nome:</label>
              <h2 className="text-lg">{nome}</h2>
            </div>

            <div>
              <label className="block text-gray-600 text-sm"><FontAwesomeIcon icon={faPhone} className="mr-2 text-green-800" /> Telefone:</label>
              <h2 className="text-lg">{telefone}</h2>
            </div>

            <div>
              <label className="block text-gray-600 text-sm"><FontAwesomeIcon icon={faEnvelope} className="mr-2 text-green-800" /> E-mail:</label>
              <h2 className="text-lg">{email}</h2>
            </div>

            <div>
              <label className="block text-gray-600 text-sm"><FontAwesomeIcon icon={faIdCard} className="mr-2 text-green-800" /> CNH:</label>
              <h2 className="text-lg">{cnh}</h2>
            </div>

            <div>
              <label className="block text-gray-600 text-sm"><FontAwesomeIcon icon={faIdBadge} className="mr-2 text-green-800" /> CPF:</label>
              <h2 className="text-lg">{cpf}</h2>
            </div>

            <div>
              <label className="block text-gray-600 text-sm"><FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2 text-green-800" /> Endereço:</label>
      ...
      <div className="bg-white/50 p-6 rounded-2xl shadow-lg w-1/2 mb-5">
        ...
        {modoEdicao ? (
          <div className="flex flex-wrap gap-4">
            <input type="text" value={marca} onChange={(e) => setMarca(e.target.value)} placeholder="Marca" className="border w-1/5 p-2 rounded" />
            <input type="text" value={modelo} onChange={(e) => setModelo(e.target.value)} placeholder="Modelo" className="border w-1/5 p-2 rounded" />
            <input type="text" value={placa} onChange={(e) => setPlaca(e.target.value)} placeholder="Placa" className="border w-1/5 p-2 rounded" />
            <input type="text" value={cor} onChange={(e) => setCor(e.target.value)} placeholder="Cor" className="border w-1/5 p-2 rounded" />
            <input type="text" value={combustivel} onChange={(e) => setCombustivel(e.target.value)} placeholder="Combustível" className="border w-1/5 p-2 rounded" />
          </div>
        ) : (
          <div className="flex flex-wrap gap-4">
