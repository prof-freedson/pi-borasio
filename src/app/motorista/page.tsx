...
export default function Motorista() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center space-y-10 bg-[#DAF3D7] bg-cover bg-center">
      ...
      {/* Perfil */}
      <div className="bg-white w-[80%] mb-1 items-center rounded-2xl flex mt-20 justify-between">
        <img
      ...
      {/* Informações Conta */}
      <div className="bg-white p-6 rounded-2xl shadow-lg w-[80%] mb-1 space-y-4">
      ...
      {/* Informações Veículo */}
      <div className="bg-white p-6 rounded-2xl shadow-lg w-[80%] mb-5">
