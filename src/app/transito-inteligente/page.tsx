...
import { ChevronLeft, Map, Clock, Smartphone, TrafficCone, AlertTriangle, BarChart2, Settings, Info } from 'lucide-react';
...
export default function TransitoInteligentePage() {
  const features = [
    {
      ...
      description: "Evitamos vias congestionadas como Av. Guajajaras e Av. dos Holandeses usando dados em tempo real",
      href: "/corridas",
    ...
    },
    {
      ...
      title: "Tempo Real",
      description: "Atualizações constantes do tráfego para calcular o trajeto mais rápido",
      href: "/tempo-real",
      linkText: "Monitorar trânsito"
    },
    {
      icon: <Smartphone className="w-8 h-8 text-[#004d2b]" />,
      title: "Integração Total",
      description: "Funciona perfeitamente com o app do motorista e do passageiro",
      href: "/integracao-app",
      linkText: "Conectar apps"
    },
    {
      icon: <TrafficCone className="w-8 h-8 text-[#004d2b]" />,
      title: "Desvios Inteligentes",
      description: "Recomenda alternativas quando há obras ou eventos na região",
  ...
  const trafficTips = [
    ...
    },
    {
      ...
      content: "Configure preferências como 'evitar pontes' ou 'rotas mais curtas'"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Nosso sistema de trânsito inteligente evita congestionamentos e encontra as melhores rotas para sua carona, economizando seu tempo e combustível.
              </p>
          ...
          <div className="mt-20 bg-white rounded-xl p-8 shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {trafficTips.map((tip, index) => (
                <div key={index} className="border-l-4 border-[#004d2b] pl-4 py-2">
          ...
          <div className="mt-16 bg-gradient-to-r from-[#004d2b] to-green-700 text-white rounded-xl p-8 text-center">
            ...
            <p className="mb-6 max-w-2xl mx-auto">
              Reduza seu tempo no trânsito e chegue mais rápido ao seu destino com nossas rotas inteligentes.
            </p>
            <Link 
              href="/cadastro" 
