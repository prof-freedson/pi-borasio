...
CREATE TYPE status_corrida AS ENUM ('pendente', 'em_andamento', 'finalizada', 'cancelada');
CREATE TYPE status_pagamento AS ENUM ('pendente', 'aprovado', 'recusado', 'reembolsado');
CREATE TYPE tipo_acessibilidade AS ENUM (
    'deficiencia_motora',
    'deficiencia_visual',
...
CREATE TABLE desvios_inteligentes (
    id SERIAL PRIMARY KEY,
    corrida_id INT NOT NULL,
...
CREATE TABLE eventos_sistema (
    id SERIAL PRIMARY KEY,
    tipo_evento tipo_evento_sistema,
    descricao TEXT,
    data_evento TIMESTAMP
);
...
-- Administrador
INSERT INTO administradores (usuario_id, nivel_acesso) VALUES
(1, 'superadmin');

-- Motorista
INSERT INTO motoristas (usuario_id, cnh, veiculo, marca, modelo, cor, ar_condicionado, combustivel, assentos) VALUES
(2, '12345678900', 'ABC-1234', 'Toyota', 'Corolla', 'Prata', true, 'gasolina', 4);

-- Passageiro
INSERT INTO passageiros (usuario_id, preferencias) VALUES
(3, 'Evitar ar-condicionado');

-- Evento cultural
INSERT INTO eventos_culturais (nome, descricao, data_evento, local) VALUES
('Festival de Música', 'Festival com artistas locais.', '2025-10-15 19:00', 'Praça Central');

-- Corrida
INSERT INTO corridas (passageiro_id, motorista_id, origem, destino, data_corrida, status, valor) VALUES
(1, 1, 'Rua A, 123', 'Rua B, 456', '2025-09-27 14:30', 'pendente', 25.00);

-- Pagamento
INSERT INTO pagamentos (corrida_id, valor_pago, data_pagamento, metodo_pagamento, status) VALUES
...
-- Desvio Inteligente
INSERT INTO desvios_inteligentes (corrida_id, rota_alternativa, motivo, data_desvio) VALUES
(1, 'Rua C -> Rua D -> Rua B', 'Trânsito intenso na rota principal', '2025-09-27 14:35');

-- Rastreamento em Tempo Real
INSERT INTO rastreamento_tempo_real (corrida_id, latitude, longitude, data_registro) VALUES
(1, -23.550520, -46.633308, '2025-09-27 14:32');

-- Avaliações
INSERT INTO avaliacoes (corrida_id, usuario_id, nota, comentario, data_avaliacao) VALUES
...
-- Terminal Rural
INSERT INTO terminais_rurais (nome, localizacao) VALUES
('Terminal Rural Norte', 'Estrada Municipal KM 15');

-- Evento do Sistema
INSERT INTO eventos_sistema (tipo_evento, descricao, data_evento) VALUES
('manutencao', 'Manutenção preventiva do sistema de rastreamento', '2025-09-25 02:00');

-- Preferências de Acessibilidade
INSERT INTO acessibilidade (usuario_id, tipo_acessibilidade, preferencias) VALUES
...
ALTER COLUMN tipo TYPE tipo_usuario 
USING tipo::tipo_usuario;
...
INSERT INTO oferta_carona (id_motorista, tipo) VALUES 
(1, 'geral'),
(2, 'grupo');

select * from oferta_carona;
...
INSERT INTO contatos (id_usuario, descricao) VALUES 
